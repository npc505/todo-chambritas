...
function Registro() {
  ...
  return (
    ...
    <div>
      <Navbar />
      <div className='grid grid-cols-1 h-[900px] mb-4'>
        <div>
                ...
                <div className="backdrop-blur-sm bg-gray-300/40 border border-gray-200/20 rounded-lg p-6 shadow-md w-[600px] h-[750px] text-center">
                    <div className='border-4 border-white rounded-lg h-full p-4'>
                        ...
                        <div className="grid grid-cols-2 gap-4 mt-4">
                            <div>
                                ...
                                <div className="relative my-2">
                                    ...
                                    <input type="text" className="bg-transparent border-2 border-white text-white text-sm rounded-lg block w-full ps-10 p-2.5 placeholder-white" placeholder="Nombre" />
                                </div>
                            </div>
                            <div>
                                ...
                                <div className="relative my-2">
                                    ...
                                    <input type="text" className="bg-transparent border-2 border-white text-white text-sm rounded-lg block w-full ps-10 p-2.5 placeholder-white" placeholder="Apellido" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="relative my-2">
                            ...
                            <input type="email" className="bg-transparent border-2 border-white text-white text-sm rounded-lg block w-full ps-10 p-2.5 placeholder-white" placeholder="name@mail.com" />
                        </div>
                        ...
                        <div className="relative my-2">
                            ...
                            <input type="tel" className="bg-transparent border-2 border-white text-white text-sm rounded-lg block w-full ps-10 p-2.5 placeholder-white" placeholder="(123) 456-7890" />
                        </div>
                        ...
                        <div className="relative my-2">
                            ...
                            <input type="password" className="bg-transparent border-2 border-white text-white text-sm rounded-lg block w-full ps-10 p-2.5 placeholder-white" placeholder="Contraseña" />
                        </div>
                        ...
                        <div className="relative my-2">
                            ...
                            <input type="password" className="bg-transparent border-2 border-white text-white text-sm rounded-lg block w-full ps-10 p-2.5 placeholder-white" placeholder="Confirmar contraseña" />
                        </div>
